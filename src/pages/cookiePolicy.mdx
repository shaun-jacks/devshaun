...
<h1>Cookie Policy for Shaun Jackson Software and Data Science Blog</h1>

<p>Last updated: October 23, 2019</p>

<p>Shaun Jackson Software and Data Science Blog ("us", "we", or "our") uses cookies on the https://shaunjacks.com website (the "Service"). By using the Service, you consent to the use of cookies.</p>
...
<h2>How Shaun Jackson Software and Data Science Blog uses cookies</h2>
...
<ul>
  <li>
    <p>
      Essential cookies. We may use cookies to remember information that changes
      the way the Service behaves or looks, such as a user's language preference
      on the Service.
    </p>
  </li>
  <li>
    <p>
      ...
      authenticate users and prevent fraudulent use of user accounts. We may use
      these cookies to remember information that changes the way the Service
...
<li>By visiting this link: <a href="https://shaunjacks.com/contact">https://shaunjacks.com/contact</a></li>
</ul>
